...
Видела ваше сообщение о недвижимости. Работаю напрямую с застройщиками!

Напишите нашему боту @TelePars24_bot — подберу варианты бесплатно!

✅ Без комиссии
✅ Помощь с ипотекой
✅ Актуальные варианты от застройщиков"""

# Альтернативные варианты сообщений (для разнообразия)
MESSAGES_VARIANTS = [
    """Добрый день! 👋

Заметила ваше сообщение про покупку недвижимости.

Напишите нашему боту @TelePars24_bot — помогу с подбором бесплатно!

Без комиссии, хорошие варианты от застройщиков.""",

    """Привет! 🏠

Увидела ваш запрос о недвижимости.

Напишите боту @TelePars24_bot — подберу варианты!

✅ Бесплатно
✅ Напрямую от застройщиков""",

    """Здравствуйте!

Прочитала ваше сообщение о покупке.

Напишите @TelePars24_bot — подберу хорошие варианты!
